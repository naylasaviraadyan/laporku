...
<body class="bg-gray-100">
    ...
    <div class="w-full min-h-screen bg-gray-100 relative overflow-hidden md:max-w-7xl md:mx-auto md:px-6">

        <!-- 🔷 NAVBAR -->
        <div class="bg-gradient-to-r from-blue-600 to-blue-400 p-10 flex justify-between items-center rounded-b-2xl">
            <h1 class="font-bold text-3xl text-white">LAPORKU</h1>
        </div>
        ...
        <div class="px-4">
            <a href="{{ route('laporan.create') }}"
                class="block bg-blue-600 text-white py-3 rounded-xl text-center font-semibold shadow">
                + Buat Laporan Baru
            </a>
        </div>
